function [vPGrid,vSGrid,rhoGrid,thckGrid,longrid,latgrid] = ...
    bldLitho1_Tamama(lonvec,latvec)
% 
...
%           P-wave velocities
% thckGrid : Grid of layer thicknesses, in m and in the same format as the 
%            P-wave velocities
...
% 
% Original author of this code is Tolulope Olugboji. This code is 
